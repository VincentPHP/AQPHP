...
class RunTime
{
    ...
    public function start()
    {
        //载入初始文件
        $files = array(
            PHP_PATH.'/common/constDirs.php',   //载入目录常量文件
            PHP_PATH.'/common/functions.php',   //载入系统函数文件
            PHP_PATH.'/common/constants.php',	//载入系统常量文件
        );
        ...
        config(require AQPHP_PATH.'/etc/Init.Config.php'); //框架常规配置项
...
<div class="box">
    ...
    <div class="content">
        ...
        <input type="text" value="app/templete/home/index/index.html">
        <h4>而此页面的对应控制器在：</h4>
        <input type="text" value="app/home/controller/Index.php">
...
str;
    ...
    public function createDir()
    {
        ...
        //检测目录是否存在 不存在则创建
        $path = array(
            CACHE_PATH,LOG_PATH,TPL_PATH, CONFIG_PATH,UPLOAD_PATH,
