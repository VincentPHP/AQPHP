...
/**
 * Main class with template resource structures and methods
 *
 * @package    Smarty
 * @subpackage Template
 *
...
class Smarty_Internal_Template extends Smarty_Internal_TemplateBase
{
    ...
    /**
     * Create template resource object
     ...
     * @param integer $cache_lifetime life time of cache resource
                                       ...
                                       $forceTplCache, $uid = null, $content_func = null)
    {
        ...
        if (isset($tpl->templateId) ? $tpl->templateId : $tpl->_getTemplateId() != $_templateId) {
            ...
            if (isset($smarty->_cache[ 'tplObjects' ][ $_templateId ])) {
                // copy resource from cached object
    ...
    /**
     * Template resource object destructor
     */
