...
abstract class Smarty_Internal_CompileBase
{
     ...
     * Optionally additional resource can be saved on stack
     *
     * @param object $compiler compiler object
     * @param string $openTag  the opening tag's name
     * @param mixed  $data     optional resource saved
     */
     ...
     *
     * @return mixed        any type the opening tag's name or saved resource
     */
