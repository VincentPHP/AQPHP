...
final class Dir
{
     ...
     */
    public static  function tree($dirName, $exts='', $son=0, $list=array())
    {
     ...
     * @return array 目录结构列表
     */
    public static function treeDir($dirName, $pid=0, $son=0, $list=array())
    {
        $dirName = self::dirPath($dirName);
     ...
     * @return bool
     */
    public static function copy($oldPath, $newPath)
    {
