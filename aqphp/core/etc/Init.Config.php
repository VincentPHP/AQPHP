...
return array(
    ...
    "DEBUG"             => TRUE,   //开启调试模式
    "VERSION"           => '1.2.0',//框架版本号
    "FONT"	            => PHP_PATH."/data/font/GABRIOLA.TTF",	 //系统字体
    ...
    //系统模板
    "TPL_STATIC"	  => PHP_PATH.'/tpl/Static/',		 //模板资源目录
    "DEBUG_TPL"       => PHP_PATH.'/tpl/Debug.tpl',      //错误异常模板
    "Index_TPL"       => PHP_PATH.'/tpl/Index.tpl',      //默认演示模板
    "ERROR_TPL"		  => PHP_PATH.'/tPl/Error.tpl',	     //错误提示模板
    "SUCCESS_TPL"	  => PHP_PATH.'/tpl/Success.tpl',    //成功提示模板
    "REDIRECT_TPL"    => PHP_PATH.'/tpl/Redirect.tpl',   //重定向模板
    ...
    "TEMPLETE_PATH"	  => APP_PATH.'/templete',//应用模块视图目录
    ...
    //SMARTY存放位置
    "SMARTY_DIR"      => PHP_ORG_PATH.'/smarty/Smarty.class.php',
);